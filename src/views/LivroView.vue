<template>
    <v-data-table :headers="headers" :items="livros" :loading="loading" sort-by="calories" class="elevation-1">
        <template v-slot:top>
                                    ...
                                    <v-row>
                                        <v-col cols="12">
                                            <v-text-field
                                                ...
                                                label="Quantidade"
                                                outlined
                                                hint="Digite a quanitdade do(s) livro(s)"
    ...
    methods: {
        initialize() {
            ...
            livroService.findAll().then(res => {
                ...
                this.totallivros = res.data.totalElements;
                this.loading = false;
            });
        },
